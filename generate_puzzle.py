...
SPORTS_TRIVIA = [
    ...
    { "type":"streak", "q":"Name 3 current Arsenal players without getting one wrong (Last Name Only).", "needed":3,
    ...
    # ===== NFL GENERAL =====
    { "type":"mc", "q":"How many NFL teams have never won a Super Bowl?", "options":["0","4","8","12"], "answer":"12" },
    { "type":"mc", "q":"How long is an NFL football field (yards)?", "options":["80","90","100","120"], "answer":"120" },
    { "type":"open", "q":"What is the name of the NFC Championship Trophy?", "answers":["George Halas Trophy","Halas Trophy", "Halas"] },
    { "type":"mc", "q":"In the NFL, how many points is a defensive safety on a 2PT play worth?", "options":["1","2","3","6"], "answer":"1" },
    { "type":"mc", "q":"In the NFL, how many players are allowed to catch the ball on a play?", "options":["5","6","17","22"], "answer":"17" },
    { "type":"open", "q":"What position is abbreviated 'NT'?", "answers":["nose tackle"] },
    { "type":"mc", "q":"When do most NFL teams start their 2-Minute Drill?", "options":["4:00","2:30","2:00","1:20"], "answer":"1:20" },
    { "type":"mc", "q":"What was the most popular NFL schematic trend in 2025?", "options":["13 personnel","Trick Plays","Dunking on the Field Goal Posts","All-Out Passing"], "answer":"13 personnel" },
    { "type":"open", "q":"Name one team with a Head Coach formerly employed by the Seahawks", "answers":["carolina", "panthers", "carolina panthers", "dallas", "cowboys", "dallas cowboys", "las vegas", "raiders", "las vegas raiders", "washington", "commanders", "washington commanders", "tennessee", "titans", "tennessee titans"] },
    { "type":"mc", "q":"How many regular season games does each NFL team play?", "options":["14","16","17","18"], "answer":"17" },

    # ===== SOCCER =====
    { "type":"mc", "q":"In the World Cup, how many players walk out for the national anthems?", "options":["20","22","30","All of them"], "answer":"All of them" },
    { "type":"open", "q":"What is the governing body of international soccer?", "answers":["fifa"] },
    { "type":"mc", "q":"What is currently the dominant offensive soccer strategy?", "options":["Set Pieces","Long Ball","Tiki Taka","Total Football"], "answer":"Set Pieces" },
    { "type":"mc", "q":"What is currently the dominant defensive soccer strategy?", "options":["Zonal Marking","Tactical Fouls","Man Marking","Sweeper Keepers"], "answer":"Man Marking" },
    ...
    { "type":"mc", "q":"Why did FIFA introduce water breaks at the 2026 World Cup?", "options":["Player Health","Time to Coach","Give the Referee a Break","Commercials"], "answer":"Commercials" },
    ...
    # ===== ULTIMATE FRISBEE =====
    { "type":"mc", "q":"How many players per team are on the field in Ultimate Frisbee?", "options":["5","6","7","9"], "answer":"7" },
    { "type":"mc", "q":"What is the self-officiating principle in Ultimate Frisbee called?", "options":["Fair Play","Honor Code","Spirit of the Game","Integrity Rule"], "answer":"Spirit of the Game" },
    { "type":"mc", "q":"Which of these is not an Ultimate frisbee tactic?", "options":["Cup","Vert Stack","Ho Stack","Quarters"], "answer":"Quarters" },
    { "type":"open", "q":"What is the scoring area in Ultimate Frisbee called?", "answers":["end zone","endzone","the end zone"] },
    { "type":"mc", "q":"How is a point started in Ultimate Frisbee?", "options":["A kickoff","A pull","A throw-in","A face-off"], "answer":"A pull" },
    { "type":"mc", "q":"In standard Ultimate Frisbee club play, how many points do you need to win?", "options":["11","13","15","21"], "answer":"15" },
    ...
    { "type":"open", "q":"What is a softball's circumference?", "answers":["12","12 inches"] },
    { "type":"mc", "q":"In softball, what is it called when a batter bunts to advance a runner but is thrown out?", "options":["Squeeze play","Sacrifice bunt","Hit and run","Safety squeeze"], "answer":"Sacrifice bunt" },
    { "type":"streak", "q":"Name 3 colleges that have won a softball championship since 2000 without getting one wrong.", "needed":3,
      "valid":["Texas","Oklahoma","UCLA","Florida State","FSU","Florida","Alabama","Arizona State","ASU","Washington","Arizona","Michigan","California"],
    },
    { "type":"mc", "q":"What color is a standard softball?", "options":["White","Yellow","Orange","Green"], "answer":"Yellow" },
]

COUPLE_TRIVIA = [
    { "type":"mc", "q":"Where did Peter & Stefanie meet?", "options":["College","Work","High School","A wedding"], "answer":"College" },
    { "type":"mc", "q":"What is the name of Peter & Stefanie's cat?", "options":["Parmesan","Oregano","Mozzarella","Dale"], "answer":"Mozzarella" },
    { "type":"open", "q":"How many cities have Peter & Stefanie combined to live in?", "answers":["8", "eight"] },
    { "type":"mc", "q":"How many times did Peter propose?", "options":["0 times","1 time","2 times","0.5 times"], "answer":"2 times" },
    { "type":"streak", "q":"Name 3 members of the wedding party without getting one wrong (first names).", "needed":3,
      "valid":["Peter","Stef","Zach","Kayla", "Dave", "David", "Danny", "Ryan", "Zachary", "Elizabeth", "Jayasaree", "Sarah", "Morgan"],
    },
    { "type":"mc", "q":"What college did Stefanie nearly attend?", "options":["Elon", "Davidson", "SUNY", "Oklahoma"], "answer":"Elon" },
    
    # ===== MORE COUPLE TRIVIA — customize as needed =====

# --- Relationship milestones ---
{ "type":"mc", "q":"What year did Stefanie & Peter start dating?", "options":["2017","2018","2019","2020"], "answer":"2018" },
{ "type":"mc", "q":"How long were they dating before getting engaged?", "options":["3 years","4 years","5 years","6 years"], "answer":"6 years" },
{ "type":"open", "q":"In what year did they get engaged?", "answers":["2024"] },
{ "type":"mc", "q":"Where did Peter propose?", "options":["The beach","At home","A hike","A restaurant"], "answer":"At home" },
{ "type":"open", "q":"What season did they get engaged in?", "answers":["spring"] },
{ "type":"mc", "q":"Where was their first date?", "options":["Go-Karting","Cheesecake Factory","Mini golf","Carowinds"], "answer":"Cheesecake Factory" },

# --- The wedding ---
{ "type":"open", "q":"What time was the ceremony supposed to start?", "answers":["4:00", "4", "4:00PM", "4pm"] },
{ "type":"mc", "q":"What is the primary wedding color?", "options":["Sage green","Blush pink","Navy blue","Green"], "answer":"Sage green" },
{ "type":"mc", "q":"What was the official guest count?", "options":["102","113","124","135"], "answer":"113" },
{ "type":"open", "q":"Did Peter or Stefanie bring more family members?", "answers":["Stefanie", "Stef"] },

# --- Peter ---
{ "type":"open", "q":"What city does Peter work in?", "answers":["renton","seattle"] },
{ "type":"open", "q":"What is Peter's middle name?", "answers":["Van Oostrum"] },
{ "type":"mc", "q":"How many siblings does Peter have?", "options":["0","1","2","3"], "answer":"2" },

# --- Stefanie ---
{ "type":"mc", "q":"What is Stefanie's Starbucks order?", "options":["Caramel Latte","Hot Chocolate","Frappucino","Just a Muffin"], "answer":"Caramel Latte" },
{ "type":"open", "q":"What is Stefanie's middle name?", "answers":["Lyn"] },
{ "type":"mc", "q":"How many siblings does Stefanie have?", "options":["0","1","2","3"], "answer":"2" },
{ "type":"open", "q":"What sport does Stefanie coach?", "answers":["softball"] },

# --- Their life together ---
{ "type":"mc", "q":"How many pets have Peter and Stefanie had together?", "options":["0","1","2"], "answer":"2" },
{ "type":"mc", "q":"What is their favorite date night?", "options":["Cooking at home","Trying new restaurants","Watching movies","Going for hikes"], "answer":"Watching Movies" },
{ "type":"open", "q":"What state do they currently live in?", "answers":["washington","wa"] },
{ "type":"mc", "q":"What show do they prefer to watch together?", "options":["Survivor","Parks & Rec","Game of Thrones","Blown Away"], "answer":"Survivor" },
{ "type":"mc", "q":"What video game do they most frequently play together?", "options":["FIFA","Rocket League","Fall Guys","Stardew Valley"], "answer":"Rocket League" },
{ "type":"open", "q":"What state did they get engaged in?", "answers":["washington","wa"] },
{ "type":"mc", "q":"Which board game do they not play frequently?", "options":["Catan","Wingspan","Carcasonne","Life"], "answer":"Life" },

# --- Fun / miscellaneous ---
{ "type":"mc", "q":"Who is the better cook?", "options":["Stefanie","Peter","Neither"], "answer":"Stefanie" },
{ "type":"mc", "q":"Who cooks more?", "options":["Stefanie","Peter","Even"], "answer":"Stefanie" },
{ "type":"mc", "q":"Who wakes up earlier?", "options":["Stefanie","Peter"], "answer":"Peter" },
{ "type":"mc", "q":"Who is better in a crisis?", "options":["Stefanie","Peter"], "answer":"Peter" },
{ "type":"mc", "q":"Who cleans up after their cat?", "options":["Stefanie","Peter", "Both"], "answer":"Stefanie" },
{ "type":"mc", "q":"Who most recently broke a bone?", "options":["Stefanie","Peter"], "answer":"Peter" },
{ "type":"mc", "q":"Who can throw a ball farther?", "options":["Stefanie","Peter"], "answer":"Peter" },
{ "type":"mc", "q":"Who collected more Super Bowl merch?", "options":["Stefanie","Peter"], "answer":"Stefanie" },
{ "type":"mc", "q":"Who was more excited to move to Washington?", "options":["Stefanie","Peter"], "answer":"Stefanie" },

{ "type":"streak", "q":"Name 3 cities the couple has lived in together without getting one wrong.", "needed":3,
  "valid":["Charlotte","Belmont","Amherst","Renton","Newcastle"],
},
]
...
CONNECTIONS_PUZZLES = [
    {
        "groups": [
            {"category": "___ Ring", "words": ["BOXING", "WEDDING", "SUPER BOWL", "ONION"], "color": "#667D5D"},
            {"category": "Football Positions", "words": ["SAFETY", "GUARD", "CENTER", "TACKLE"], "color": "#8B7355"},
            {"category": "Soccer Terms", "words": ["CORNER", "PITCH", "HEADER", "BICYCLE"], "color": "#5B7B8A"},
            {"category": "Softball Techniques", "words": ["BUNT", "SLAP", "DIVE", "TAG"], "color": "#9B6B8A"},
        ]
    },
    {
        "groups": [
            {"category": "Offensive Players", "words": ["LOCKETT", "STAAL", "HAVERTZ", "WALKER"], "color": "#667D5D"},
            {"category": "Defensive Players", "words": ["WITHERSPOON", "LOVE", "SLAVIN", "TIMBER"], "color": "#8B7355"},
            {"category": "Pokemon Games", "words": ["SWORD", "SAPPHIRE", "EMERALD", "DIAMOND"], "color": "#9B6B8A"},
            {"category": "Jewelry", "words": ["RING", "PENDANT", "NECKLACE", "PIERCING"], "color": "#5B7B8A"},
        ]
    },
    {
        "groups": [
            {"category": "Flowers", "words": ["ROSE", "LILY", "PEONY", "TULIP"], "color": "#667D5D"},
...
TTAL_QUESTIONS = [
    ...
    {"statements": ["Peter played ultimate frisbee in high school", "Stefanie studied abroad in Oceania", "The couple's first date was bowling"], "lie": 2},
    {"statements": ["The couple has had 2 pets together", "Stefanie's favorite food is sushi", "Peter has run over 75 miles since January"], "lie": 1},
    {"statements": ["Peter won the Seahawks March Madness challenge this year", "Peter & Stefanie have more cat toys than board games", "Stefanie coaches softball every day"], "lie": 2},
    {"statements": ["Peter has been to all 30 NFL stadiums", "Stefanie has been to multiple national parks", "The couple met on campus at Queens University"], "lie": 0},
    {"statements": ["Stefanie's middle name is spelled L-Y-N", "Peter owns an official big hat", "Their cat's favorite spot is watching the birdfeeder"], "lie": 2},
    {"statements": ["They have never turned on their electric fireplace", "Peter can juggle", "Stefanie played softball in high school"], "lie": 1},
    {"statements": ["Stefanie still enjoys coconut maccaroons", "Peter asked Stefanie's parents for permission the same day he proposed.", "Their favorite restaurant is Blazing Onion"], "lie": 0},
    {"statements": ["The couple has matching tattoos", "Peter has worked in four different sports", "Stefanie goes to every Seahawks game"], "lie": 0},
    {"statements": ["Stefanie was the only Siemens employee in the Pacific time zone", "Their favorite video game together was It Takes Two", "Peter designed two plays that got used in-game last season"], "lie": 2},
    {"statements": ["The wedding colors include sage green", "Stefanie has never been on a cruise", "Peter picks the music in their house"], "lie": 2},
]

OVERUNDER_QUESTIONS = [
    {"q": "Number of guests at this wedding", "number": 125, "answer": "under"},
    {"q": "Miles from Washington to Mount Airy", "number": 2700, "answer": "over"},
    {"q": "Stefanie's softball teams coached", "number": 3.5, "answer": "over"},
    {"q": "Days the couple dated before getting engaged", "number": 1500, "answer": "over"},
    {"q": "Days the couple was engaged before getting married", "number": 900, "answer": "under"},
    {"q": "States Peter has visited", "number": 29.5, "answer": "under"},
    {"q": "NFL games Peter went to before 18", "number": 4.5, "answer": "under"},
    {"q": "Total Countries the couple has visited (together or apart)", "number": 3.5, "answer": "over"},
    {"q": "Total different sports they have gone to together", "number": 6.5, "answer": "over"},
    {"q": "Total Countries the couple has visited (together or apart)", "number": 3.5, "answer": "over"},
    {"q": "Total Countries the couple has visited (together or apart)", "number": 3.5, "answer": "over"},
]
